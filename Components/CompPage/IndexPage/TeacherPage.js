...
import IntegrationNotistack from "../../Notification/Alert";
import InputAdornment from "@material-ui/core/InputAdornment";
import VisibilityIcon from "@material-ui/icons/Visibility";
import SearchIcon from "@material-ui/icons/Search";
import { withSnackbar } from "notistack";
import Static from "../../static";
import FormInfoInterested from "../../Desires/FormInfoInterested";
import AlertDialog from "../../Notification/ConfiremDeleteDialog";
import DialogOrderOfDesires from "../../Desires/OrderOfDesires";
import {
  openToastSuccess,
  openToastError,
  openToastInfo,
...
import replaceStrIcon from "../../IconReplaceTxt/IconRepTxt";

const TeacherPage = ({ dataserver }) => {
  /**----------------all useState----------------------- */
  const rouet = useRouter();
  console.log(dataserver);
  const [loading, setLoading] = useState(false), //جاري التحميل للجدول الرئيسي و احصائيات المدارس
    [listMoassat, setListMoassat] = useState(loopforUser(dataserver)), //قائمة المؤسسات المعنية بالحركة
  ...
  // useEffect(() => {
  //   fetcher(`/api/getListForSchoolManager/${rouet.query.year}`)
  //     .then((res) => {
