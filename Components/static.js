...
function HomeIcon(props) {
  return (
    <SvgIcon {...props}>
      <Image src="/cards/kids_school.svg" alt="" layout="fill" />
    </SvgIcon>
  );
}
...
const Static = (prpos) => {
 ...
 const arrItem = [
  {key:"potentialVacancy",name:"محتمل الشغور",src:"/cards/mohtamal.svg"},
    ...
    return (
      ...
      <Paper elevation={3} className={classe.buttonPaper}>
        <Grid container wrap="nowrap">
          <Grid item container xs={8} style={{ padding: "5px 22px 0 22px" }} justifyContent="space-around" direction="column">
            <Typography
              variant="body1"
              component="h4"
              align="left"
          ...
          <Grid item xs={4} style={{ backgroundImage:`url(${x.src})`,backgroundPosition:"center",backgroundRepeat:'no-repeat',backgroundSize:"cover"}}>
